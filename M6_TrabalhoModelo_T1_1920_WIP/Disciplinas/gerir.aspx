<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gerir.aspx.cs" Inherits="M6_TrabalhoModelo_T1_1920_WIP.Disciplinas.gerir" %>
...
where codigo=@codigo"
                SelectCommand="select * from disciplinas" UpdateCommand="UPDATE disciplinas SET nome = @nome, nr_modulos = @nr_modulos, ano_escolaridade = @ano_escolaridade WHERE (codigo = @codigo)">
                <DeleteParameters>
